...
<flowgorithm fileversion="4.0">
    <attributes>
        ...
        <attribute name="saved" value="2024-02-28 04:43:55 "/>
        <attribute name="created" value="R2FicmllbC5DYW1wb3M7TlQxOTsyMDI0LTAyLTIxOyIwMTozMjo0MyAiOzI4MDA="/>
        <attribute name="edited" value="R2FicmllbC5DYW1wb3M7TlQxOTsyMDI0LTAyLTI4OyIwNDoyOTo0MyAiOzQyOzI5Nzc="/>
        <attribute name="edited" value="cGF1bG8uaGVucmlxdWU7TlQyMTsyMDI0LTAyLTI4OyIwNDozOToyNSAiOzE7MzAyMw=="/>
        <attribute name="edited" value="c29maWEucGVyZWlyYTtOVDE1OzIwMjQtMDItMjg7IjA0OjQzOjU1ICI7MTsyODg4"/>
    </attributes>
    ...
    <function name="qtdeDelim" type="Integer" variable="qtdeDelim">
        ...
        <body>
            <declare name="qtdeDelim" type="Integer" array="False" size=""/>
            <declare name="i" type="Integer" array="False" size=""/>
            <assign variable="i" expression="0"/>
            <assign variable="qtdeDelim" expression="0"/>
